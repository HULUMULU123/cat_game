...
import { QuizResponse } from "../../shared/api/types";
        ...
        <StyledAnswersList>
          {quiz ? (
            quiz.answers.map((answer, index) => {
              ...
              return (
                <StyledAnswersItem key={`${index}-${answer}`} $isCorrect={isCorrect}>
                  <StyledAnwerContent>
                    <StyledAnswerNumber>{index + 1}</StyledAnswerNumber>
                    <StyledAnswerText $isCorrect={isCorrect}>{answer}</StyledAnswerText>
                  </StyledAnwerContent>
                </StyledAnswersItem>
              );
            })
